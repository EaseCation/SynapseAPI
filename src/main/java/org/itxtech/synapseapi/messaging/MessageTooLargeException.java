...
public class MessageTooLargeException
    ...
    public MessageTooLargeException(int length) {
        this("Attempted to send a plugin message that was too large. The maximum length a plugin message may be is 1048576 bytes (tried to send one that is " + length + " bytes long).");
    }
