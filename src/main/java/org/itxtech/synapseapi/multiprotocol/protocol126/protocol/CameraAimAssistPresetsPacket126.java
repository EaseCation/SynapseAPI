...
@ToString
public class CameraAimAssistPresetsPacket126 extends Packet126 {
    ...
    public void encode() {
        ...
        for (Category category : categories) {
            ...
            putUnsignedVarInt(category.entityTypeFamiliesPriorities.length);
            for (Priority priority : category.entityTypeFamiliesPriorities) {
                putString(priority.identifier);
                putLInt(priority.priority);
            }
        ...
        for (CameraAimAssistPreset preset : presets) {
            ...
            putUnsignedVarInt(preset.entityTypeFamiliesExclusions.length);
            for (String exclusion : preset.entityTypeFamiliesExclusions) {
                putString(exclusion);
            }
