 ...
 */
@ToString
public class GraphicsOverrideParameterPacket12630 extends Packet12630 {
    ...
    public String biome;
    /**
     * Determines which player the override parameter is applied to.
     */
    @Nullable
    ...
    public void encode() {
        ...
        putString(biome);
        putOptional(playerIdentifier, BinaryStream::putString);
        putByte(type);
        putBoolean(reset);
    }
}
