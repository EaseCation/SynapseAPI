...
@ToString
public class StartGamePacket12630 extends Packet12630 {
    ...
    public static final int EDITOR_WORLD_TYPE_TEST_LEVEL = 2;
    ...
    public int editorWorldType = EDITOR_WORLD_TYPE_NON_EDITOR;
    public boolean createdInEditorMode;
    public boolean exportedFromEditorMode;
    ...
    public String vanillaVersion = "1.26.30";
    ...
    public String serverEngine = "1.26.30";
    ...
    public void encode() {
        ...
        this.putBoolean(this.createdInEditorMode);
        this.putBoolean(this.exportedFromEditorMode);
        ...
        this.putBoolean(this.muteEmoteAnnouncements);
        ...
        this.putBoolean(this.isChatLogging);
        this.putOptional(this.serverConfig, (stream, server) -> {
            stream.putOptional(server.gatheringConfig, (bs, gathering) -> {
                bs.putUUID(gathering.experienceId);
                bs.putString(gathering.experienceName);
                bs.putUUID(gathering.experienceWorldId);
                bs.putString(gathering.experienceWorldName);
                bs.putString(gathering.creatorId);
                bs.putUUID(gathering.targetId);
                bs.putString(gathering.scenarioId);
                bs.putString(gathering.serverId);
            });
            stream.putOptional(server.storeConfig, (bs, store) -> {
                bs.putString(store.storeId);
                bs.putString(store.storeName);
            });
            stream.putOptional(server.presenceConfig, (bs, presence) -> {
                bs.putOptional(presence.experienceName, BinaryStream::putString);
                bs.putOptional(presence.worldName, BinaryStream::putString);
                bs.putString(presence.richPresenceId);
            });
        });
