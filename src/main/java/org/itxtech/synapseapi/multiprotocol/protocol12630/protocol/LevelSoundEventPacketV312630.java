...
@ToString
public class LevelSoundEventPacketV312630 extends Packet12630 {
    ...
    public DataPacket fromDefault(DataPacket pk, AbstractProtocol protocol, boolean netease) {
        ...
        this.sound = LevelSoundEventMap.getName(LevelSoundEventUtil.translateIdToClient(packet.sound, protocol, netease));
