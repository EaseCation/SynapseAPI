...
@ToString
public class InventoryContentPacket12630 extends Packet12630 {
    ...
    @Override
    public InventoryContentPacket12630 clone() {
        InventoryContentPacket12630 pk = (InventoryContentPacket12630) super.clone();
