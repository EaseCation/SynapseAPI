...
@ToString
public class MobArmorEquipmentPacket12630 extends Packet12630 {
    ...
    public void decode() {
        ...
        this.slots[0] = this.getItemStack();
        this.slots[1] = this.getItemStack();
        this.slots[2] = this.getItemStack();
        this.slots[3] = this.getItemStack();
        this.body = this.getItemStack();
    }
    ...
    public void encode() {
        ...
        this.putItemStack(this.slots[0]);
        this.putItemStack(this.slots[1]);
        this.putItemStack(this.slots[2]);
        this.putItemStack(this.slots[3]);
        this.putItemStack(this.body);
    }
