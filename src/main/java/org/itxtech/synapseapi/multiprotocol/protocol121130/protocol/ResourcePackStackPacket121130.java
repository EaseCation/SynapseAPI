...
@ToString
public class ResourcePackStackPacket121130 extends Packet121130 {
    ...
    public String gameVersion = "1.21.130";
    ...
    public void encode() {
        ...
        for (Experiment experiment : experiments.experiments) {
    ...
    public DataPacket fromDefault(DataPacket pk, AbstractProtocol protocol, boolean netease) {
        ...
        this.resourcePackStack = netease ? ArrayUtils.addAll(packet.resourcePackStack, packet.behaviourPackStack) : packet.resourcePackStack;
        return this;
    }
