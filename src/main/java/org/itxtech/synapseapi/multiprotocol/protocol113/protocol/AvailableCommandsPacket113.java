...
public class AvailableCommandsPacket113 extends Packet113 {
    ...
    private static final Map<CommandParamType, Integer> v12To113ArgTypeTable = new HashMap<CommandParamType, Integer>(){{
        ...
        commands.forEach((name, cmdData) -> {
            ...
            for (CommandOverload overload : data.overloads.values()) {
                ...
                for (CommandParameter parameter : overload.input.parameters) {
                    ...
                    int type = 0;
                    int translatedType = v12To113ArgTypeTable.getOrDefault(parameter.type, ARG_TYPE_INT);
                    if (parameter.postFix != null) {
