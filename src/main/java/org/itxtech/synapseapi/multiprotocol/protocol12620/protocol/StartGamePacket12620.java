...
@ToString
public class StartGamePacket12620 extends Packet12620 {
    ...
    public String vanillaVersion = "1.26.20";
    ...
    public String serverEngine = "1.26.20";
    ...
    public void encode() {
        ...
        this.putOptional(this.serverConfig, (stream, server) -> {
            ...
            stream.putOptional(server.presenceConfig, (bs, presence) -> {
                bs.putString(presence.experienceName != null ? presence.experienceName : " ");
                bs.putString(presence.worldName != null ? presence.worldName : " ");
            });
        });
