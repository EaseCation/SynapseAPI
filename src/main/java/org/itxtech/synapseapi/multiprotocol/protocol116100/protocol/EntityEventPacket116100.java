...
@ToString
public class EntityEventPacket116100 extends Packet116100 {
	public static final int NETWORK_ID = ProtocolInfo.ACTOR_EVENT_PACKET;
	...
	public DataPacket fromDefault(DataPacket pk, AbstractProtocol protocol, boolean netease) {
		EntityEventPacket packet = (EntityEventPacket) pk;
		this.eid = packet.eid;
		this.event = packet.event;
		this.data = packet.data;

		if (packet.event == EntityEventPacket.EATING_ITEM && packet.data != 0) {
