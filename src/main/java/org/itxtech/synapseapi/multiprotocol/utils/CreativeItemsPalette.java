...
*/
            ...
            register(AbstractProtocol.PROTOCOL_121_111, CreativeInventoryNew.getItems(), null);
            register(AbstractProtocol.PROTOCOL_121_120, CreativeInventoryNew.getItems(), null);
            register(AbstractProtocol.PROTOCOL_121_124, CreativeInventoryNew.getItems(), null);
            register(AbstractProtocol.PROTOCOL_121_130, CreativeInventoryNew.getItems(), null);
            register(AbstractProtocol.PROTOCOL_126, CreativeInventoryNew.getItems(), null);
            register(AbstractProtocol.PROTOCOL_126_10, CreativeInventoryNew.getItems(), null);
            register(AbstractProtocol.PROTOCOL_126_20, CreativeInventoryNew.getItems(), null);
            register(AbstractProtocol.PROTOCOL_126_30, CreativeInventoryNew.getItems(), null);
        }
    ...
    public static void cachePackets() {
        ...
        for (AbstractProtocol protocol : AbstractProtocol.getValues()) {
            ...
            if (protocol.getProtocolStart() >= AbstractProtocol.PROTOCOL_121_60.getProtocolStart()) {
                ...
                creativeContentPacketNe.groups = groups;
