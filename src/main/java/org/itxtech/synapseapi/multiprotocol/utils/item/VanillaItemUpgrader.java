...
//        addSchema("0065_1.18.10_to_1.18.20.27_beta.json", V1_18_30); // experiment only
        ...
        addSchema("0171_1.20.60.26_beta_to_1.20.70.24_beta.json", V1_20_70);
        addSchema("0181_1.20.70.24_beta_to_1.20.80.24_beta.json", V1_20_80);
        addSchema("0191_1.20.80.24_beta_to_1.21.0.25_beta.json", V1_21_0);
        addSchema("0201_1.21.0.25_beta_to_1.21.20.24_beta.json", V1_21_20);
        addSchema("0211_1.21.20.24_beta_to_1.21.30.24_beta.json", V1_21_30);
        addSchema("0221_1.21.30.24_beta_to_1.21.40.20_beta.json", V1_21_40);
        addSchema("0231_1.21.40.25_beta_to_1.21.50.29_beta.json", V1_21_50);
        addSchema("0241_1.21.50.29_beta_to_1.21.80.27_beta.json", V1_21_80);
        ...
        addSchema("0301_1.21.130.24_beta_to_1.26.20.28_beta.json", V1_26_20);
        addSchema("0311_1.26.20.28_beta_to_1.26.30.28.json", V1_26_30);
