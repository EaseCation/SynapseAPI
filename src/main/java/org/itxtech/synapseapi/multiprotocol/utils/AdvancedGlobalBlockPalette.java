...
public final class AdvancedGlobalBlockPalette {
    ...
    static {
        ...
        PaletteBlockTable table11910 = PaletteBlockTable.fromNBTV3("block_state_list_119.nbt", true);
        ...
        palettes.put(AbstractProtocol.PROTOCOL_119_10, new AdvancedGlobalBlockPaletteInterface[]{
                new GlobalBlockPaletteNBT(AbstractProtocol.PROTOCOL_119_10, table11910, null, true)
        });
        ...
        staticPalettes.put(StaticVersion.V1_19_10, new GlobalBlockPaletteStatic(palettes.get(AbstractProtocol.PROTOCOL_119_10)[0]));
    }
