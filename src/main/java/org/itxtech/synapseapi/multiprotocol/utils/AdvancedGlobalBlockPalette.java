...
*/
        palettes.put(AbstractProtocol.PROTOCOL_121_50, new AdvancedGlobalBlockPaletteInterface[]{
                ...
                new GlobalBlockPaletteNBT(AbstractProtocol.PROTOCOL_121_50, RuntimeBlockMapper.PALETTES.get(AbstractProtocol.PROTOCOL_121_50)[1].palette),
        });
        palettes.put(AbstractProtocol.PROTOCOL_121_60, new AdvancedGlobalBlockPaletteInterface[]{
                new GlobalBlockPaletteNBT(AbstractProtocol.PROTOCOL_121_60, RuntimeBlockMapper.PALETTES.get(AbstractProtocol.PROTOCOL_121_60)[0].palette),
        });
        palettes.put(AbstractProtocol.PROTOCOL_121_70, new AdvancedGlobalBlockPaletteInterface[]{
                new GlobalBlockPaletteNBT(AbstractProtocol.PROTOCOL_121_70, RuntimeBlockMapper.PALETTES.get(AbstractProtocol.PROTOCOL_121_70)[0].palette),
        });
        palettes.put(AbstractProtocol.PROTOCOL_121_80, new AdvancedGlobalBlockPaletteInterface[]{
                new GlobalBlockPaletteNBT(AbstractProtocol.PROTOCOL_121_80, RuntimeBlockMapper.PALETTES.get(AbstractProtocol.PROTOCOL_121_80)[0].palette),
        });
        ...
        palettes.put(AbstractProtocol.PROTOCOL_121_93, new AdvancedGlobalBlockPaletteInterface[]{
                ...
                new GlobalBlockPaletteNBT(AbstractProtocol.PROTOCOL_121_93, RuntimeBlockMapper.PALETTES.get(AbstractProtocol.PROTOCOL_121_93)[1].palette),
        });
        ...
        palettes.put(AbstractProtocol.PROTOCOL_121_111, new AdvancedGlobalBlockPaletteInterface[]{
                new GlobalBlockPaletteNBT(AbstractProtocol.PROTOCOL_121_111, RuntimeBlockMapper.PALETTES.get(AbstractProtocol.PROTOCOL_121_111)[0].palette),
                new GlobalBlockPaletteNBT(AbstractProtocol.PROTOCOL_121_111, RuntimeBlockMapper.PALETTES.get(AbstractProtocol.PROTOCOL_121_111)[1].palette),
        });
        palettes.put(AbstractProtocol.PROTOCOL_121_120, new AdvancedGlobalBlockPaletteInterface[]{
                new GlobalBlockPaletteNBT(AbstractProtocol.PROTOCOL_121_120, RuntimeBlockMapper.PALETTES.get(AbstractProtocol.PROTOCOL_121_120)[0].palette),
                new GlobalBlockPaletteNBT(AbstractProtocol.PROTOCOL_121_120, RuntimeBlockMapper.PALETTES.get(AbstractProtocol.PROTOCOL_121_120)[1].palette),
        });
        palettes.put(AbstractProtocol.PROTOCOL_121_124, new AdvancedGlobalBlockPaletteInterface[]{
                new GlobalBlockPaletteNBT(AbstractProtocol.PROTOCOL_121_124, RuntimeBlockMapper.PALETTES.get(AbstractProtocol.PROTOCOL_121_124)[0].palette),
                new GlobalBlockPaletteNBT(AbstractProtocol.PROTOCOL_121_124, RuntimeBlockMapper.PALETTES.get(AbstractProtocol.PROTOCOL_121_124)[1].palette),
        });
        palettes.put(AbstractProtocol.PROTOCOL_121_130, new AdvancedGlobalBlockPaletteInterface[]{
                new GlobalBlockPaletteNBT(AbstractProtocol.PROTOCOL_121_130, RuntimeBlockMapper.PALETTES.get(AbstractProtocol.PROTOCOL_121_130)[0].palette),
        });
        palettes.put(AbstractProtocol.PROTOCOL_126, new AdvancedGlobalBlockPaletteInterface[]{
                new GlobalBlockPaletteNBT(AbstractProtocol.PROTOCOL_126, RuntimeBlockMapper.PALETTES.get(AbstractProtocol.PROTOCOL_126)[0].palette),
        });
        palettes.put(AbstractProtocol.PROTOCOL_126_10, new AdvancedGlobalBlockPaletteInterface[]{
                new GlobalBlockPaletteNBT(AbstractProtocol.PROTOCOL_126_10, RuntimeBlockMapper.PALETTES.get(AbstractProtocol.PROTOCOL_126_10)[0].palette),
        });
        palettes.put(AbstractProtocol.PROTOCOL_126_20, new AdvancedGlobalBlockPaletteInterface[]{
                new GlobalBlockPaletteNBT(AbstractProtocol.PROTOCOL_126_20, RuntimeBlockMapper.PALETTES.get(AbstractProtocol.PROTOCOL_126_20)[0].palette),
        });
        palettes.put(AbstractProtocol.PROTOCOL_126_30, new AdvancedGlobalBlockPaletteInterface[]{
                new GlobalBlockPaletteNBT(AbstractProtocol.PROTOCOL_126_30, RuntimeBlockMapper.PALETTES.get(AbstractProtocol.PROTOCOL_126_30)[0].palette),
        });
        ...
        for (StaticVersion version : StaticVersion.getValues()) {
            if (version.getProtocol() < AbstractProtocol.FIRST_AVAILABLE_PROTOCOL.getProtocolStart()) {
                continue;
            }
            if (staticPalettes.get(version) == null) {
                throw new AssertionError();
            }
        }
    }
...
*/
        ...
        staticPalettes.put(StaticVersion.V1_21_50_NETEASE, new GlobalBlockPaletteStatic(palettes.get(AbstractProtocol.PROTOCOL_121_50)[1]));
        ...
        staticPalettes.put(StaticVersion.V1_21_111_NETEASE, new GlobalBlockPaletteStatic(palettes.get(AbstractProtocol.PROTOCOL_121_111)[1]));
        staticPalettes.put(StaticVersion.V1_26_10, new GlobalBlockPaletteStatic(palettes.get(AbstractProtocol.PROTOCOL_126_10)[0]));
        staticPalettes.put(StaticVersion.V1_26_20, new GlobalBlockPaletteStatic(palettes.get(AbstractProtocol.PROTOCOL_126_20)[0]));
        staticPalettes.put(StaticVersion.V1_26_30, new GlobalBlockPaletteStatic(palettes.get(AbstractProtocol.PROTOCOL_126_30)[0]));
    }
