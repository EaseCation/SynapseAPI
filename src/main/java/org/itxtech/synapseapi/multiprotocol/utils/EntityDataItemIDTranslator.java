...
public class EntityDataItemIDTranslator {
	...
	public static final int V116210_BUOYANCY_DATA = 120;
	public static final int V116210_FREEZING_EFFECT_STRENGTH = 121;
	...
	static {
		...
		v12ToV112Book.forEach(v12ToV116210Book::put);
