...
public class EntityDataItemIDTranslator {
	...
	static {
		...
		v12ToV14Book.put(Entity.DATA_URL_TAG, ACTIONS);
		...
		v12ToV111Book.put(Entity.DATA_URL_TAG, V111_URL_TAG);
		...
		v12ToV112Book.put(Entity.DATA_NPC_DATA, V112_NPC_DATA);
		v12ToV112Book.put(Entity.DATA_SKIN_ID, V112_SKIN_ID);
		v12ToV112Book.put(Entity.DATA_URL_TAG, V112_URL_TAG);
		...
		// 1.19.0
		v12ToV117Book.put(DATA_PLAYER_LAST_DEATH_POS, V1190_PLAYER_LAST_DEATH_POS);
		v12ToV117Book.put(DATA_PLAYER_LAST_DEATH_DIMENSION, V1190_PLAYER_LAST_DEATH_DIMENSION);
		v12ToV117Book.put(DATA_PLAYER_HAS_DIED, V1190_PLAYER_HAS_DIED);
	}
