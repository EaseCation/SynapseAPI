...
public class LevelSoundEventPacket16 extends Packet16 {
    ...
    public DataPacket fromDefault(DataPacket pk, AbstractProtocol protocol, boolean netease) {
        ...
        this.y = packet.y;
        this.z = packet.z;
        this.extraData = Optional.ofNullable(sound).orElse(LevelSoundEventEnum.SOUND_UNDEFINED).translateTo16ExtraData(packet.extraData, protocol, netease);
