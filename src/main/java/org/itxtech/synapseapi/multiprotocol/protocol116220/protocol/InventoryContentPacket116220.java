...
@ToString
public class InventoryContentPacket116220 extends Packet116220 {
    ...
    @Override
    public InventoryContentPacket116220 clone() {
        InventoryContentPacket116220 pk = (InventoryContentPacket116220) super.clone();
